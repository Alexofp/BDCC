extends Object
class_name NOET # NpcOwner Event Tag

const Mean = "mean" #This event includes a lot of mean things (roughness) being done to the PC
const Kind = "kind" #This event is kind
