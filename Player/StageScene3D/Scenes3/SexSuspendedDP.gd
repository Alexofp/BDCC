...
func playAnimation(animID, _args = {}):
	...
	if(animID == "tease"):
		state_machine.travel("SuspendedDPTease_1-loop")
		state_machine2.travel("SuspendedDPTease_2-loop")
		state_machine3.travel("SuspendedDPTease_3-loop")
	if(animID == "inside"):
		state_machine.travel("SuspendedDPInside_1-loop")
		state_machine2.travel("SuspendedDPInside_2-loop")
		state_machine3.travel("SuspendedDPInside_3-loop")
	if(animID == "sex"):
		state_machine.travel("SuspendedDP_1-loop")
		state_machine2.travel("SuspendedDP_2-loop")
		state_machine3.travel("SuspendedDP_3-loop")
	if(animID == "fast"):
		state_machine.travel("SuspendedDPFast_1-loop")
		state_machine2.travel("SuspendedDPFast_2-loop")
		state_machine3.travel("SuspendedDPFast_3-loop")
