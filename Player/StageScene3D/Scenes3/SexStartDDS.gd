...
func playAnimation(animID, _args = {}):
	...
	if(animID == "start"):
		state_machine.travel("ThreesomeStartDDS_1-loop")
		state_machine2.travel("ThreesomeStartDDS_2-loop")
		state_machine3.travel("ThreesomeStartDDS_3-loop")
	if(animID == "defeated"):
		state_machine.travel("ThreesomeStartDDSDef_1-loop")
		state_machine2.travel("ThreesomeStartDDS_2-loop 2")
		state_machine3.travel("ThreesomeStartDDS_3-loop 2")
