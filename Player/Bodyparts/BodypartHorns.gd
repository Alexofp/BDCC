...
func getTransformMorphMessage(_context:Dictionary) -> String:
	...
	return "{npc.YourHis} horn"+("s begin to change their shape. They twist and curl" if !wasSingle else " begins to change its shape. It twists and curls")+", taking a new, different form. {npc.YouHe} now {npc.youHaveHeHas} "+getAVulgarName()+"."
