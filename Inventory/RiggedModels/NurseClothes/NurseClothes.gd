...
func updateFromItem(_item):
	...
	setShaderMatTexturePath(bodywidepng, "res://Inventory/RiggedModels/NurseClothes/bodyTop.png" if !_state.isShirtOpened() else "res://Inventory/RiggedModels/CasualClothes/ShirtOpen.png")
