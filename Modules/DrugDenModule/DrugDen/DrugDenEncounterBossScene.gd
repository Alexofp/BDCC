...
func _run():
	...
	if(state == "make_strange_pill"):
		saynn("You haphazardly mix questionable fluids, guided by the provided notes, your gut instinct and a bit of luck. The result is a strange, weird pill. Who knows what it will do, its color is unsettling. You pocket it, hoping it won’t kill you later. Time to move on.")
