...
func _run():
	...
	if(state == "resist"):
		playAnimation(StageScene.TentaclesSex, "tease", {bodyState={naked=true}})
	...
	if(state == "give_in"):
		playAnimation(StageScene.TentaclesSex, "sex", {bodyState={naked=true}})
	...
	if(state == "isolation"):
		playAnimation(StageScene.TentaclesSex, "fast", {bodyState={naked=true}})
	...
	if(state == "let_it_happen"):
		playAnimation(StageScene.TentaclesSex, "inside", {bodyState={naked=true}})
