...
func _run():
	...
	if(state == "get_locked"):
		playAnimation(StageScene.MilkingStallDuo, "start", {pc="pc", npc="eliza", bodyState={exposedChest=true, hard=true, chains=[["hoseshort", "penisPump", "scene", "milktank"], ["short", "neck", "scene", "bottompipe"]]}})
	...
	if(state == "do_milk_start"):
		playAnimation(StageScene.MilkingStallDuo, "watch", {pc="pc", npc="eliza", bodyState={exposedChest=true, hard=true, chains=[["hoseshort", "penisPump", "scene", "milktank"], ["short", "neck", "scene", "bottompipe"]]}})
	...
	if(state == "do_milk_fast"):
		playAnimation(StageScene.MilkingStallDuo, "watchfast", {pc="pc", npc="eliza", bodyState={exposedChest=true, hard=true, chains=[["hoseshort", "penisPump", "scene", "milktank"], ["short", "neck", "scene", "bottompipe"]]}})
	...
	if(state == "process_cum"):
		playAnimation(StageScene.MilkingStallDuo, "watchcum", {pc="pc", npc="eliza", bodyState={exposedChest=true, hard=true, chains=[["hoseshort", "penisPump", "scene", "milktank"], ["short", "neck", "scene", "bottompipe"]]}})
