...
func _run():
	...
	if(state == "get_locked"):
		...
		saynn("She squeezes some more onto her strapon and uses her paw to spread it along the full length with a few strokes..")

		saynn("She aligns her.. tool.. with your quivering entrance.. and slowly begins the process. With gentle pushes, she makes the strap prod at your tailhole.. easing in the rounded tip at first with not much trouble, thanks to the lube.")

		saynn("[say=pc]Mhh..[/say]")

		saynn("As she continues to sink in the slick strapon into you, you feel it quickly finding and pressing against your prostate.")
		...
		saynn("Eliza continues to gently push her hips forward, driving her rubber cock inside you.. until she is satisfied enough.")
	...
	if(state == "do_sex"):
		...
		saynn("Each of her next thrusts send shivers down your spine.. your tailhole clenching tightly around that strapon as it keeps pushing on your pleasure spot.. causing your {pc.penis} to twitch and leak more of that prostate fluid.")
	...
	if(state == "process_cum"):
		...
		saynn("It continues for a while..")
	...
	if(state == "after_milking"):
		...
		saynn("After what seems like an eternity of raw, relentless stimulation, Eliza gradually eases her motions, leaving most of her strap to rest inside your pulsing rear. It lets you finally snap out of that ecstatic state and start trying to rest..")
		...
		saynn("Eliza carefully withdraws her toy, allowing your hole to close..")
	...
	if(state == "get_up_after"):
		...
		saynn("Eliza takes off her harness and presses a few buttons on the computer that make it let go of your limbs.")
