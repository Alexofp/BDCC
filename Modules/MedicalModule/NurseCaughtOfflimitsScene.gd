...
func addWonButton():
	...
	addButtonWithChecks("Sex!", "Time to fuck them!", "startsexasdom", [], [ButtonChecks.NotArmsRestrained, ButtonChecks.NotHandsBlocked, ButtonChecks.NotLegsRestrained, ButtonChecks.NotGagged, ButtonChecks.NotBlindfolded, ButtonChecks.HasStamina])
