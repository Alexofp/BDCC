...
func _run():
	if(state == ""):
		...
		saynn("[say=pc]You’re gonna hide behind your shield all day, director?[/say]")
		...
		saynn("[say=directortau]Look whose side she has chosen.[/say]")
		...
		saynn("[say=directortau]You really think you’re doing something good here? Look around, so much effort, all gone to waste. So many lives, destroyed.[/say]")
		...
		saynn("[say=directortau]Do you think I’m happy about this? It must be done, Tavi. If I don’t kill you, the war will. You simply don’t have what it takes. I’m doing what nature does, replacing the weak with the strong.[/say]")
	...
	if(state == "directors_last_words"):
		...
		saynn("[say=directortau]It’s okay, Elena. It was gonna happen at some point.. ugh. Me and you did a lot together. Our efforts won’t go unnoticed.[/say]")
	...
	if(state == "director_dies"):
		...
		saynn("Elena quietly sobs. She deserves to be dealt with too. But. Your gaze gets glued to an interesting room. It piques your interest, the name and the possible information that you can probably find there. And right now you need all the information you could find, the guy wasn’t too keen on sharing.")
	...
	if(state == "elena_kneels"):
		...
		saynn("[say=pc]Now how about you tell me the information about every single staff member who works or has ever worked here~.[/say]")
		...
		saynn("[say=elena]I can’t kill you, Tavi. I can’t hurt you at all. But there is nothing I can do to save you either. I detect.. that you’re screwed. HaHa-Ha-haha.[/say]")
