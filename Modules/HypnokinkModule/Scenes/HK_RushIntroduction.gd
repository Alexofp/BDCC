...
func _run():
	...
	if(state == ""):
		...
		saynn("[say=HK_Rush]Name's Rush. Can I help ya', pipsqueak?[/say]")
		...
		saynn("[say=HK_Rush]Spit it out, I don' have all day. Whaddya want?[/say]")
		
		addButton("Mention Vion", "", "no_bully")
	if(state == "no_bully"):
		saynn("[say=HK_Rush]Oh, four-eyes sent ya, eh? Tha's cute.[/say]")

		saynn("He leaps up, grabbing onto a support beam holding up the ceiling and starts doing pull-ups.")

		saynn("[say=HK_Rush]Now why- would I- do tha'?- Pushin' him- about 's- hilarious,-[/say]")

		saynn("He lets go with one hand, switching to one-armed pull-ups.")

		saynn("[say=HK_Rush]he's tryin'- to be all- [i]dignified[/i]- but I can- tell tha' he's- itchin' for it-[/say]")

		saynn("He swaps hands and even picks up the pace.")

		saynn("[say=HK_Rush]and I want- that ass- an' besides- if he won't- put out it's- easy credits-[/say]")
		...
		saynn("[say=HK_Rush]for me! So yeah- pipsqueak- wha's- in it- for me?[/say]")
