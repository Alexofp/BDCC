...
func _run():
	if(state == ""):
		...
		saynn("[say=HK_Vion]Focus on your legs for me. Flex your toes.[/say]")

		saynn("You slowly wiggle your toes.")

		saynn("[say=HK_Vion]Tense your legs. Lock them in place, as rigid as steel. Don't curl up, just tense in place.[/say]")

		saynn("You tense the muscles in your legs. Like forcing a spring to coil up.")

		saynn("[say=HK_Vion]Tense even more, until its almost painful. Now hold it. Feel that tension.[/say]")

		saynn("[say=HK_Vion]You carry some of this tension with you all day, every day. You don't even notice its there. But when you bring it to the surface like this...[/say]")

		saynn("Your legs almost feel like they're vibrating. Your toes curl. The tension builds, and builds...")

		saynn("[say=HK_Vion]Now... Release all of it. Let it dissolve and fade away.[/say]")
		...
		saynn("[say=HK_Vion]Good. Isn't that better? Now the same with your arms. Tense them up. Ball your hands into fists. Tighter.[/say]")

		saynn("You squeeze hard. Your hands shake as if you were struggling against invisible restraints.")

		saynn("[say=HK_Vion]Build it up. Put as much effort into holding still as you can.[/say]")

		saynn("Your jaw tightens. Twitches and tremors travel up your arms, along your shoulders and down your back.")

		saynn("[say=HK_Vion]And... release. Let it all flow out.[/say]")
		...
		saynn("[say=HK_Vion]Perfect.[/say]")

		saynn("[say=HK_Vion]Feel how limber your body can be, how effortless it can be to flex and stretch...[/say]")
