...
func _run():
	if(state == ""):
		...
		saynn("[say=HK_Vion]At your side, there's a sturdy storage box. Take all your cares and your worries, all your troubles and anxieties, and place them in the box. They'll be safe in there until you need to take up their burden again. Until that time comes, you can just leave them in there.[/say]")
		...
		saynn("[say=HK_Vion]Now... close the lid.[/say]")

		saynn("It snaps shut with a satisfying click, the edges hissing as they self-seal until the contents are needed again.")

		saynn("[say=HK_Vion]Already the memories of your problems are fading away, dissapearing from your mind. Now, push the box aside and leave it behind. You don't need it right now. It's time to step outside for a while.[/say]")
		...
		saynn("[say=HK_Vion]Go outside, out into that empty space, deeper into a relaxing trance. Floating away. Whichever part of the universe you always wanted to visit, there you are.[/say]")
		
		saynn("You look around, taking in the sights.")
		
		saynn("[say=HK_Vion]Here, in the void, nothing can reach you. Nothing can trouble you. You'll return in time, but that time is not now. For now... just relax. Free and content. Just drift.[/say]")
