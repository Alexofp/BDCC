...
func _run():
	...
	if(state == "nod"):
		saynn("You nod slightly. Risha chuckles and strips the crotch piece of her heavy armor. Then she pulls down her panties and exposes her girthy cock. It’s about 25cm and is of a feline type, no knot or anything, just little barbs on its long tip.")
...
func _react(_action: String, _args):
	...
	if(_action == "nod"):
		...
		GM.pc.addSkillExperience(Skill.CumLover, 50, "risha_stocksblow")
