...
func _run():
	if(state == ""):
		saynn("You decide to idle for some time in the lilac block, wondering if that white fluffy ball will decide to come out of her cell today. Busting into it yourself would be kinda mean.. so you keep that option as a last resort.")
		...
		saynn("Maybe it's time to give up waiting..")
	...
	if(state == "artica_hungry"):
		...
		saynn("After seeing that other inmates don't pay much attention to her, the white-cyan fluff sticks more of her body out. Your careful gaze picks up on her holding her paw on her belly.. grumbling belly. Looks like she is forced to start exploring the station.")
